...
/*¿Qué es eso de typeTarget? Lo de poner una constante en una propiedad de una etiqueta HTML no es nuevo,
recuerda que eso se hace cuando quieres variar una clase y cosas así, como hacíamos en el juego del ahorcado 
del modulo 3 o en las paletas del módulo 2. En este caso, esa propiedad está regida por una condición,
escrita en un ternario. Esa condición tiene, a su vez, la posibilidad de que una props (que es lo nuevo de
esta lección, lo que luego se define en la madre), sea true (en cuyo caso se cambiará por "_blank"
